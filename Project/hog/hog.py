...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if now == 1:
            one = True
        ans += now
    return ans if one == False else 1
    # END PROBLEM 1
...
def swine_align(player_score, opponent_score):
    ...
    return False if player_score == 0 or opponent_score == 0 else False if gcd(player_score, opponent_score) < 10 else True
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return True if player_score < opponent_score and player_score + 2 >= opponent_score else False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def announce(score0, score1, max0=0, max1=0):
        if who == 0:
            cur_score = score0
        else:
            cur_score = score1
        if cur_score - last_score > running_high:
            print(cur_score - last_score, "point(s)! The most yet for Player", who)
            return announce_highest(who, cur_score, cur_score - last_score)
